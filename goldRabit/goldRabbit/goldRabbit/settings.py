"""
Django settings for goldRabbit project.
...
#SECRET_KEY = 'django-insecure-px$s$3y@c3ifim@90(rp*wku%mlr^gwgz4f-fo+6=c16umz8x='
...
INSTALLED_APPS = [
    ...
    'goldRabbitSite.apps.GoldrabbitsiteConfig',
    'corsheaders'
]
